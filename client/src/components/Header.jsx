...
function Header() {
    ...
    const username = user?.email.split('@')[0] || ''; // Handle if user or email is undefined

    return (
        <header>
            <div className="header" style={{backgroundColor:"#f5f5f5", marginBottom: "5px"}}>
                <img src="logo.gif" style={{height: "100px"}} alt="logo"/>
            </div>
                        ...
                        <ul className="navbar-nav mb-2 mb-md-0">
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    {username} {/* Display the extracted username */}
                                </a>
